package com.demo.spring.batch.demo5.job;
...
import com.demo.spring.batch.demo5.mapper.EmployeeDBRowMapper;
import com.demo.spring.batch.demo5.mapper.EmployeeFileRowMapper;
import com.demo.spring.batch.demo5.model.Employee;
import com.demo.spring.batch.demo5.processor.EmployeeProcessor;
import com.demo.spring.batch.demo5.writer.EmailSenderWriter;
import com.demo.spring.batch.demo5.writer.EmailSenderWriter3;
...
public class Demo5 {
    ...
    @Bean
    public Step step3Demo5() throws Exception {
        return this.stepBuilderFactory.get("step3")
        		.allowStartIfComplete(false)
                .<Employee, EmployeeDTO>chunk(10)
                .reader(employeeDBReader())
                .writer(emailSenderWriter3())
                .build();
    }
    ...
    @Bean
    EmailSenderWriter3 emailSenderWriter3() {
        return new EmailSenderWriter3();
    }
